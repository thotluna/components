...
const choices = {
  ...
  boxShadow: {
    ...
    focusInT: '0 0 0 1px var(--color-primary)',
    focusOutT: '0 0 10px 0 var(--color-primary)',
  },
  borderRadius: {
    none: '0',
    sm: '10px',
...
const decisions = {
  color: {
    ...
    dark: {
      background: choices.color.brand.fullDarkBlue,
      primary: choices.color.brand.darkBlue,
      secondary: choices.color.brand.fusia,
      font: {
        base: choices.color.base.white,
        muted: choices.color.brand.grayLight,
      },
      button: {
        primary: choices.color.brand.darkBlue,
        secondary: choices.color.brand.fusia,
        base: choices.color.base.transparent,
      },
      boxShadow: {
        none: 'none',
        xs: 'none',
    ...
    light: {
      background: choices.color.brand.whiteBlue,
      primary: choices.color.brand.darkBlue,
      secondary: choices.color.brand.fusia,
      font: {
        base: choices.color.base.white,
      ...
      boxShadow: {
        none: 'none',
        xs: `0px 3px 6px ${choices.color.brand.shadowGray}`,
        sm: `0px 4px 5px ${choices.color.brand.shadowGray}`,
      },
    },
  },
  container: {
